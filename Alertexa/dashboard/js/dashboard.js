...
if(brandCode == null){
    ...
    swal("Un Authrised User !", "Do Not Waste Your Time !", "warning");
}
var allUserData = JSON.parse(localStorage.getItem(brandCode+"_brand"));
var brandNameEl = document.getElementById("brand-name");
brandNameEl.innerHTML = "Welcome to "+allUserData.brandName;

// start logout coding
var logoutBtn = document.querySelector("#logout-btn");
logoutBtn.onclick = function(){
    this.innerHTML = "Please waitt...";
...
//create subject
var createSubject = document.querySelector("#first");
createSubject.onclick = function(){
    // this.innerHTML = "Please waitt...";
    createSubject.disabled = true;
    // this.style.background = "#ccc";
    setTimeout(function(){
        window.location = "../dashboard/pages/createSubject.html";
        // sessionStorage.removeItem("brandCode");
    },3000)
}
    ...
    newQuestions.forEach((question,index)=>{
        ...
        <div class="mb-5" index="${index}">
            ...
            <div>
                ...
                <br><br>
                <span class="correct-answer-badge text-white p-3">${question.correctAnswer}</span>
                <br><br>
            </div>
        </div>
        `;
